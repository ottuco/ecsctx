...
- install_maskers() sweeps any live handler ecsctx did not build. Its two
  halves are exported too: install_maskers_in_config() for a LOGGING dict,
  install_maskers_on_handlers() for the live tree alone.
