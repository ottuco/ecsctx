...
could ship unmasked logs off-host: every shipping handler (anything other
than a console/no-op handler) must either carry mask_pii_filter itself, or
only be reached by loggers that carry it.
